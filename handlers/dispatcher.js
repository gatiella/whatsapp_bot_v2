...
async function dispatchCommand(sock, msg, store) {
  ...
  try {
    ...
    } else if (['stalk', 'phoneosint', 'stalkwatch', 'myonline', 'usersearch', 'pastebin', 'anonymous', 'ghostlist', 'autotyping', 'clone', 'fakeonline', 'lastseen', 'fake', 'impersonate', 'stylemode', 'recallall', 'mimic', 'ghostmode', 'busy', 'scheduledm', 'recall', 'spy', 'rizz', 'suggestreply', 'persona', 'chat', 'clearchat'].includes(cmd)) {
